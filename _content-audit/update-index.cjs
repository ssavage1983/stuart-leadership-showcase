...
const coreCompetencies = [
  ...
  { title: "Digital Transformation & AI Integration", desc: "Proprietary tooling, workflow automation" }
];
...
const experience = [
  ...
  },
  {
    ...
    summary: "Led end-to-end high-volume event operations, including the full holiday and Christmas programme, managing a team of up to 15 front-of-house and bar staff. Elevated operational hygiene and compliance by writing the food safety manual, implementing structured daily checks, and training staff to standard.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Designed and executed a self-motivated, high-stakes 18-month global expedition to study international landscapes, demonstrating exceptional personal resilience, logistics planning, and risk management.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Managed a portfolio of independent commercial launch projects, directing local logistics, fleet dispatch operations, and physical site scheduling under tight delivery constraints.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Spearheaded frontline passenger operations and safety compliance within one of the world's busiest, highly regulated transport environments. Coordinated multi-disciplinary hospitality teams of up to 25 staff to maintain service standards under pressure.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Optimised digital order fulfilment, dispatch workflows, and delivery vehicle scheduling to boost operational performance and logistical throughput.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Developed and structured the organisation's first comprehensive B2B distribution and delivery network across London, aligning driver resources with corporate client timelines.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Directed daily retail operations for high-turnover flagship locations while taking full ownership of staff rotas, inventory pipelines, daily financial audits, and a rapidly scaling digital dispatch system.",
    responsibilities: [
  ...
  },
  {
    ...
    summary: "Led high-volume hospitality operations, taking full accountability for a team of up to 40 service and kitchen employees, shift patterns, P&L controls, and on-site health and safety compliance.",
    responsibilities: [
  ...
  },
  {
    ...
    dates: "Jul 2001 – Sep 2004 (Industry Placement, prior to BA Hons Graphic Communications 2004-2006)",
...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Operations & Project Delivery Leader based in Kennington, London." },
      { property: "og:title", content: "Stuart Savage | Operations & Project Delivery Leader" },
      { property: "og:description", content: "Operations & Project Delivery Leader based in Kennington, London." },
      { property: "og:image", content: "https://stuart-leadership-showcase.vercel.app/images/profile/stuart-savage.jpg" },
...
const BulletItem = ({ children }: { children: React.ReactNode }) => (
  <li className="relative pl-5 leading-relaxed text-[#607080] text-sm">
    <span className="absolute left-0 top-0 text-[#c47c62] select-none text-base leading-relaxed">•</span>
    {children}
  </li>
);
...
function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#f7f4ee] text-[#102a43] font-sans antialiased">
      ...
      <a href="#main" className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-50 focus:rounded focus:bg-[#102a43] focus:px-4 focus:py-2 focus:text-white">
        Skip to main content
      </a>
      ...
      <section className="relative bg-[#091d2f] text-[#f7f4ee] pt-16 pb-12 px-6 lg:pt-24 lg:pb-16 overflow-hidden border-b border-[#c47c62]/30">
        <div className="absolute inset-0 z-0 bg-cover bg-center opacity-30 mix-blend-overlay" style={{ backgroundImage: "url('/images/portfolio/tooting-bec-japanese-garden-seating-and-warm-night-lighting.jpg')" }} />
        ...
        <div className="relative z-10 mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          <div className="lg:col-span-8 space-y-6">
            ...
            <p className="text-base sm:text-lg text-[#f7f4ee]/80 max-w-2xl leading-relaxed">
              With 20+ years leading operations across safety-critical, high-volume, and commercially complex environments, Stuart Savage brings a rare combination of strategic infrastructure planning and hands-on frontline delivery.
            </p>

            <div className="border-l-3 border-[#c47c62] pl-4 text-xs sm:text-sm text-[#f7f4ee]/90 font-medium max-w-2xl">
              A proven multi-brand founder, airport operations manager, and internationally seconded service leader, he specialises in building systems, teams, and workflows that perform under pressure — from Heathrow terminals to remote Amazonian fieldwork. Trusted to govern compliance, drive digital transformation, and close projects with integrity.
            </div>

            <div className="pt-2 flex flex-wrap gap-4 items-center">
              <a href="#competencies" className="inline-flex items-center justify-center min-h-[48px] px-5 bg-[#c47c62] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#c7a667] hover:text-[#091d2f] transition-colors rounded-sm">
                Core Competencies
              </a>
              <a href="#experience" className="inline-flex items-center justify-center min-h-[48px] px-5 border border-[#c47c62] bg-[#f7f4ee]/10 text-[#f7f4ee] text-xs font-bold uppercase tracking-wider hover:bg-[#c7a667] hover:text-[#091d2f] hover:border-[#c7a667] transition-colors rounded-sm">
                Professional Experience
              </a>
              <a href={LINKEDIN} target="_blank" rel="noreferrer" className="text-xs font-semibold uppercase tracking-wider text-[#f7f4ee] hover:text-[#c47c62] transition-colors underline underline-offset-4">
          ...
          <div className="lg:col-span-4 flex justify-center lg:justify-end">
            <figure className="relative w-full max-w-[340px] rounded border border-[#f7f4ee]/30 bg-[#091d2f] shadow-2xl overflow-hidden">
              <img src="/images/profile/stuart-savage.jpg" alt="Stuart Savage" width="680" height="850" decoding="async" className="w-full h-auto object-cover aspect-[4/5]" />
      ...
      <nav className="sticky top-[92px] z-40 bg-[#f7f4ee]/95 backdrop-blur border-b border-[#102a43]/16 py-3 px-6 text-center text-[10px] font-bold uppercase tracking-[0.13em]">
        <div className="mx-auto max-w-7xl flex flex-wrap justify-center gap-2 sm:gap-4">
          <a href="#competencies" className="px-3 py-1.5 border border-transparent hover:border-[#c47c62]/40 hover:text-[#c47c62] transition-colors rounded-sm">Competencies</a>
          <a href="#experience" className="px-3 py-1.5 border border-transparent hover:border-[#c47c62]/40 hover:text-[#c47c62] transition-colors rounded-sm">Experience</a>
          <a href="#education" className="px-3 py-1.5 border border-transparent hover:border-[#c47c62]/40 hover:text-[#c47c62] transition-colors rounded-sm">Education</a>
          <a href="#interests" className="px-3 py-1.5 border border-transparent hover:border-[#c47c62]/40 hover:text-[#c47c62] transition-colors rounded-sm">Interests</a>
          <a href="#contact" className="px-3 py-1.5 border border-transparent hover:border-[#c47c62]/40 hover:text-[#c47c62] transition-colors rounded-sm">Contact</a>
        </div>
      </nav>
      ...
      <main id="main" className="mx-auto max-w-7xl px-6 py-12 space-y-16">
        ...
        {/* Core Competencies */}
        <section id="competencies" className="scroll-mt-36 bg-[#091d2f] text-[#f7f4ee] p-8 sm:p-12 rounded-lg border border-[#c47c62]/30">
        ...
        <section id="experience" className="scroll-mt-36 space-y-8">
          ...
          <ol className="space-y-4">
            {experience.map((role) => {
              ...
              return (
                <li key={role.id} id={"role-" + role.id} className={"border rounded-lg transition-all " + (role.featured ? "border-[#c47c62]/45 border-l-5 border-l-[#c47c62] bg-gradient-to-r from-white to-[#f7f4ee]" : "border-[#102a43]/16 bg-white/50")}>
                  <button type="button" onClick={() => toggleRole("role-" + role.id)} className="w-full text-left p-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 cursor-pointer">
                    <div className="space-y-1">
                      <span className="text-xs font-bold uppercase tracking-wider text-[#c47c62]">{role.dates}</span>
                      <h3 className="text-xl font-bold uppercase text-[#102a43] leading-snug">{role.role}</h3>
                  ...
                  {isOpen && (
                    <div className="px-6 pb-6 border-t border-[#102a43]/10 pt-4 text-xs sm:text-sm text-[#607080] space-y-5">
                      {role.summary && (
                        <p className="text-sm font-semibold text-[#102a43] leading-relaxed border-b border-[#102a43]/10 pb-4">{role.summary}</p>
                      )}
                      
                      {role.responsibilities && (
                        <div className="space-y-2">
                          <p className="text-xs font-bold uppercase tracking-wider text-[#102a43]">Key Responsibilities</p>
                      ...
                      {role.achievements && (
                        <div className="space-y-2 pt-2">
                          <p className="text-xs font-bold uppercase tracking-wider text-[#102a43]">Key Achievements</p>
                          <ul className="list-none space-y-2">
