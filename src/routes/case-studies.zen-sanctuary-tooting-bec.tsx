    ...
    <div className="min-h-screen bg-background text-foreground animate-fadeIn transition-opacity duration-700">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4 mb-8 transform transition-all duration-700 translate-y-0 opacity-100">
          ...
          >
            <Sparkles className="w-3.5 h-3.5 text-primary" /> Project Archive · Meditative Urban
            Design & Natural Hard Landscaping
          </Badge>
          <h1 className="text-4xl font-bold tracking-tight">Zen Sanctuary, Tooting Bec</h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            Transforming an overlooked south London plot into a serene, contemplative haven through
            balanced asymmetrical zoning, natural slate, and architectural evergreen planting.
          </p>
        </div>
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          <section className="space-y-4 transition-all duration-500">
            ...
            <p>
              Situated in Tooting Bec, this residential garden required a complete psychological and
              physical reset from the bustle of urban life. The legacy space lacked focal points,
              suffered from irregular boundary lines, and featured outdated paving that failed to
              drain properly during heavy rainfall.
            </p>
            <p>
              The design objective was to invoke traditional Japanese meditative
              principles—simplicity, asymmetry, and natural texturing—using sustainable materials
              and hardy evergreens that require minimal ongoing maintenance.
            </p>
          </section>
          ...
          <div className="rounded-xl overflow-hidden border shadow-sm my-6">
            <img
              ...
              alt="Tooting Bec Japanese Garden Gravel Path and Climbers"
          ...
          <section className="space-y-6">
            ...
            <p>
              To ensure impeccable spatial proportions and rigorous build quality, the project was
              executed in four structured phases:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Excavating uneven sub-grades, establishing precise fall gradients, and installing
                  hidden gravel soakaways to manage surface runoff efficiently.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Laying oversized natural slate stepping stones through decorative gravel beds to
                  create deliberate, mindful walking rhythms across the plot.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Sourcing structural specimen plants—such as pruned conifers, Japanese acers, and
                  cascading ferns—to maintain year-round tonal depth.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Erecting dark-stained vertical slatted timber screening and discreet low-voltage
                  uplighting to enhance evening serenity.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4 pt-4">
            ...
            <p>
              The Tooting Bec Zen Sanctuary demonstrates how disciplined space planning and tactile
              natural materials can completely redefine an urban environment. The project achieved a
              zero-defect handover, delivering an enduring space for relaxation and mental clarity.
            </p>
          </section>
        </div>
      </div>
