    ...
    <div className="min-h-screen bg-background text-foreground animate-fadeIn transition-opacity duration-700">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4 mb-8 transform transition-all duration-700 translate-y-0 opacity-100">
          ...
          >
            <Maximize className="w-3.5 h-3.5 text-primary" /> Project Archive · Spatial Geometry &
            Hardscaping
          </Badge>
          <h1 className="text-4xl font-bold tracking-tight">Geometric Harmony, Tooting Bec</h1>
          <p className="text-xl text-muted-foreground leading-relaxed">
            Executing precise, angular hardscaping and zoned outdoor living spaces to maximize
            utility and visual depth in a linear Tooting Bec property.
          </p>
        </div>
        ...
        <div className="mb-12 rounded-xl overflow-hidden border shadow-sm">
          <img
            ...
            alt="Tooting Bec Geometric Garden Night Lighting"
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          <section className="space-y-4 transition-all duration-500">
            ...
            <p>
              Located in Tooting Bec, this property featured a narrow, linear garden that felt
              visually restrictive. The legacy layout consisted of tired turf and unstructured
              boundaries that emphasized the site's narrow proportions.
            </p>
            <p>
              The design objective was to introduce sharp, intersecting geometric zones to disrupt
              the linear perspective. This required extreme operational precision—angular paving
              cuts, exact levelling, and perfectly aligned timber screening had to be executed
              flawlessly to prevent the geometry from feeling disjointed.
            </p>
          </section>
          ...
          <section className="space-y-6">
            ...
            <p>
              To ensure the intersecting lines aligned perfectly across the site, the build was
              strictly managed across four execution phases:
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Utilizing laser levels and string lines to physically map the intersecting angles,
                  ensuring the sub-base excavations perfectly mirrored the final architectural
                  design.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Executing complex wet-cuts on large-format paving units to create seamless
                  diagonal transitions between the dining patio and the primary walkway.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Constructing crisp, horizontal slatted timber boundaries and integrated floating
                  bench seating that mirrored the angular lines of the ground-level masonry.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Introducing soft, textured grasses and fluid perennial planting beds to
                  deliberately contrast with and soften the rigid geometric borders of the
                  hardscaping.
                </p>
              </div>
            </div>
          ...
          <section className="space-y-4 pt-4">
            ...
            <p>
              ...
              landscape architecture. By treating the garden installation with the same rigorous
              tolerances as an interior build, the project delivered a sophisticated, modern
              entertaining space that entirely redefined the property's footprint.
            </p>
          </section>
        </div>
      </div>
