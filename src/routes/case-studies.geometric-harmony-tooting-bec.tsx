        ...
        <div className="mt-10">
          <figure className="mb-10 overflow-hidden rounded border border-[#102845]/15 bg-white shadow-sm">
            <img
              ...
              alt="Geometric Harmony, Tooting Bec"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12">
            <div className="rounded border border-[#102845]/15 bg-white p-5 shadow-sm">
              ...
              <div className="mt-2 text-xl font-bold text-[#102845]">Angular Zoning</div>
            </div>
            <div className="rounded border border-[#102845]/15 bg-white p-5 shadow-sm">
              <span className="text-xs font-bold uppercase tracking-wider text-[#b99a60]">
                Materials / Scope
              </span>
              <div className="mt-2 text-xl font-bold text-[#102845]">Precision Paving</div>
            </div>
            <div className="rounded border border-[#102845]/15 bg-white p-5 shadow-sm">
              <span className="text-xs font-bold uppercase tracking-wider text-[#b99a60]">
                Quality Standard
