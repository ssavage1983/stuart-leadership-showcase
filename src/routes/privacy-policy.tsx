        ...
        <article className="max-w-4xl mx-auto space-y-12">
          ...
          >
            ...
            <p className="text-sm text-slate-700 leading-relaxed">
              ...
              It preserves selected writing, project material, case studies, horticultural notes,
            ...
            <div className="bg-white p-5 border-l-4 border-[#b99a60] text-sm text-[#102845] rounded shadow-sm space-y-2">
              ...
              <ul className="list-disc list-inside text-xs text-slate-700 leading-relaxed space-y-1 pl-2">
                <li>
                  The former limited company <strong>Savage Bespoke Ltd</strong> closed in{" "}
                  <strong>2023</strong>.
                </li>
                <li>
                  The former sole trader practices <strong>Stuart Savage Landscaping</strong> and{" "}
                  <strong>The Moonlight Garden Design Co. (Moonlight Studio)</strong> closed in{" "}
          ...
          <section id="contact" className="scroll-mt-6 space-y-4">
            ...
            <div className="bg-[#c7d0c5] p-6 rounded space-y-2 text-sm text-[#102845]">
              <p>
                For legal, privacy, accessibility, or archive permissions, email:{" "}
              ...
              <p className="text-xs text-[#41505b]">
                Note: Savage Bespoke Ltd closed in 2023. Stuart Savage Landscaping and The Moonlight
                Garden Design Co. closed in May 2026. No trade services, quotes, or commercial
                projects are offered through this site.
              </p>
            </div>
          </section>
        </article>
