    ...
    <div className="min-h-screen bg-background text-foreground animate-fadeIn transition-opacity duration-700">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-4 mb-8 transform transition-all duration-700 translate-y-0 opacity-100">
          ...
          >
            <Sparkles className="w-3.5 h-3.5 text-primary" /> Project Archive · Traditional Cottage
            Restoration & Courtyard Design
          </Badge>
        ...
        <div className="space-y-10 text-muted-foreground leading-relaxed">
          <section className="space-y-4 transition-all duration-500">
            ...
            <p>
              Nestled behind a traditional Victorian cottage in Balham, this compact courtyard
              required a sensitive refurbishment to honor the property's historical era while
              upgrading its drainage and seating utility. The existing surface was uneven, poorly
              drained, and dominated by cracked concrete.
            </p>
            <p>
              The objective was to introduce warm, tactile natural materials—such as reclaimed stock
              brick borders and tumbled Yorkstone paving—paired with cottage-garden planting to
          ...
          <section className="space-y-6">
            ...
            <p>
              To ensure structural longevity and authentic aesthetic integration, the project was
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2">
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Breaking out degraded concrete slabs, excavating for correct fall gradients, and
                  laying a compacted MOT Type 1 sub-base with integrated drainage channels.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Constructing raised planter beds using reclaimed London stock bricks and
                  hand-laying tumbled natural stone flags with traditional mortar joints.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Introducing multi-season cottage favorites—such as climbing roses, lavender, and
                  herbaceous perennials—to soften masonry boundaries.
                </p>
              </div>
              ...
              <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Applying breathable stone sealers, cleaning joint lines, and ensuring flawless
                  threshold transitions from the interior kitchen.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-4 pt-4">
            ...
            <p>
              The Balham Cottage Courtyard successfully marries historical craftsmanship with modern
              structural reliability. By maintaining rigorous quality control and careful material
              sourcing, the project delivered an authentic period aesthetic backed by zero-defect
              engineering.
            </p>
          </section>
        </div>
